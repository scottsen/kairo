...
- **[ADR-005: Chemistry Domain](../ADR/005-chemistry-domain.md)** — Architectural decision record
- **[SPEC-CHEMISTRY.md](../SPEC-CHEMISTRY.md)** — Technical specification of chemistry operators
