...
**See also:** SPEC-COORDINATE-FRAMES.md for full frame specification.
...
Transformations integrate with the coordinate frame system (see SPEC-COORDINATE-FRAMES.md).
...
- **Frame-aware transforms** (integration with SPEC-COORDINATE-FRAMES.md)
...
✅ **Frame integration** (works with SPEC-COORDINATE-FRAMES.md)
...
- **SPEC-COORDINATE-FRAMES.md** — Frame/anchor system
- **SPEC-GEOMETRY.md** — Geometric operators
- **SPEC-OPERATOR-REGISTRY.md** — Layer 2 (transforms)
