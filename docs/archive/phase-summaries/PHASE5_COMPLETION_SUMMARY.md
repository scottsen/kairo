...
### 1. Audio Dialect (`kairo/mlir/dialects/audio.py`) - ✅ 618 lines
...
### 3. Compiler Integration (`kairo/mlir/compiler_v2.py`) - ✅ +319 lines
...
- **`kairo/mlir/dialects/__init__.py`**: Export AudioDialect
- **`kairo/mlir/lowering/__init__.py`**: Export AudioToSCFPass
