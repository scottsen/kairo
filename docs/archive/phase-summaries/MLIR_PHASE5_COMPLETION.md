...
- ✅ Complete MLIR CLI command (`kairo mlir`)
...
### 1. Optimization Infrastructure (`kairo/mlir/optimizer.py`)
...
Updated `kairo mlir` command to fully compile and optimize programs:

```bash
kairo mlir program.kairo
```
...
```bash
# Compile single file
kairo mlir examples/v0_3_1_velocity_calculation.kairo

# Compile with optimization
kairo mlir examples/v0_3_1_recursive_factorial.kairo
```
...
### New Files
- `kairo/mlir/optimizer.py` - Optimization pass infrastructure and passes
- `tests/test_mlir_phase5.py` - Comprehensive Phase 5 tests
- `docs/MLIR_PHASE5_COMPLETION.md` - This documentation

### Modified Files
- `kairo/cli.py` - Implemented `cmd_mlir()` function
