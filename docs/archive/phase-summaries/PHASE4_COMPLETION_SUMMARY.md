...
### 1. Agent Dialect (`kairo/mlir/dialects/agent.py`)
...
### 2. Agent-to-SCF Lowering (`kairo/mlir/lowering/agent_to_scf.py`)
...
### 3. Compiler Integration (`kairo/mlir/compiler_v2.py`)
...
|-----------|------|-------|---------|
| Agent Dialect | `kairo/mlir/dialects/agent.py` | 526 | High-level operations |
| Agent Lowering | `kairo/mlir/lowering/agent_to_scf.py` | 434 | SCF transformation |
| Lowering Init | `kairo/mlir/lowering/__init__.py` | +13 | Export agent pass |
| Compiler | `kairo/mlir/compiler_v2.py` | +280 | Compilation methods |
...
1. **Created:**
   ...
   - `kairo/mlir/dialects/agent.py` (new implementation)
   - `kairo/mlir/lowering/agent_to_scf.py` (new pass)
   - `tests/test_agent_dialect.py` (new tests)
   - `examples/phase4_agent_operations.py` (new examples)

2. **Updated:**
   - `kairo/mlir/lowering/__init__.py` (export agent pass)
   - `kairo/mlir/compiler_v2.py` (agent methods)
