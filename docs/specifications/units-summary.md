...
### 1. Core Unit System (`kairo/types/units.py`)
...
### 2. Type System Integration (`kairo/ast/types.py`)
...
### 3. Type Checker Enhancement (`kairo/ast/visitors.py`)
