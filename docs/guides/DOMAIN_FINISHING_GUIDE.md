...
**What it means:**
- Operators implemented in `kairo/stdlib/{domain}.py`
- Basic tests exist
...
Create `kairo/core/domain_registry.py`:
...
**Runtime binding in `kairo/runtime/runtime.py`:**
...
Create `kairo/type_system/units.py`:
...
```python
# kairo/type_system/type_checker.py
...
```python
# kairo/type_system/domain_types.py
...
```python
# kairo/type_system/rate_checking.py
...
```python
# kairo/mlir/dialects/rigidbody.py
...
```python
# kairo/mlir/lowering/rigidbody_to_scf.py
...
- [ ] MLIR dialect defined (`kairo/mlir/dialects/{domain}.py`)
- [ ] Lowering pass implemented (`kairo/mlir/lowering/{domain}_to_scf.py`)
...
kairo check main.kairo --domain graph
