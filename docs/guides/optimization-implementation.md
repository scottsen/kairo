...
Additionally, the existing **Genetic Algorithm (GA)** implementation in `kairo/stdlib/genetic.py` provides complete evolutionary computation capabilities.
...
```
kairo/stdlib/optimization.py          # Main optimization module (1,200+ lines)
...
kairo/stdlib/genetic.py               # Genetic algorithm (600 lines)
