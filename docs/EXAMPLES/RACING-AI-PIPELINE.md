...
kairo run examples/racing_ai/simple_track.yaml
...
- [SPEC-PHYSICS-DOMAINS.md](../SPEC-PHYSICS-DOMAINS.md) — Physics operators
...
- [DOMAIN_ARCHITECTURE.md](../DOMAIN_ARCHITECTURE.md) — Full domain vision
