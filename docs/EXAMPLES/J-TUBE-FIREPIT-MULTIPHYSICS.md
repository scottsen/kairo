...
5. **Documentation** — Update DOMAIN_ARCHITECTURE.md, operator registry
...
- **[SPEC-OPERATOR-REGISTRY.md](../SPEC-OPERATOR-REGISTRY.md)** — Operator metadata and layering
- **[SPEC-COORDINATE-FRAMES.md](../SPEC-COORDINATE-FRAMES.md)** — Frames and anchor system
