...
**Related:** [SPEC-TIMBRE-EXTRACTION.md](../SPEC-TIMBRE-EXTRACTION.md), [ADR-002](002-cross-domain-architectural-patterns.md), [DOMAIN_ARCHITECTURE.md](../DOMAIN_ARCHITECTURE.md)
...
- **[SPEC-TRANSFORM.md](../SPEC-TRANSFORM.md)** — FFT, STFT operators
- **[SPEC-OPERATOR-REGISTRY.md](../SPEC-OPERATOR-REGISTRY.md)** — Operator metadata
- **[AUDIO_SPECIFICATION.md](../AUDIO_SPECIFICATION.md)** — Audio domain
- **[DOMAIN_ARCHITECTURE.md](../DOMAIN_ARCHITECTURE.md)** — Domain layers
