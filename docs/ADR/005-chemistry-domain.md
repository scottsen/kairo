...
- **[SPEC-CHEMISTRY.md](../SPEC-CHEMISTRY.md)** — Complete technical specification of chemistry operators
- **[USE_CASES/chemistry-workflows.md](../USE_CASES/chemistry-workflows.md)** — Real-world chemistry workflow examples
- **[DOMAIN_ARCHITECTURE.md](../DOMAIN_ARCHITECTURE.md)** — How chemistry fits into Kairo's domain structure
