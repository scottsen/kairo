...
**Supersedes:** N/A
**Related:** ADR-002 (Cross-Domain Architectural Patterns), GPU_MLIR_PRINCIPLES.md
...
- **GPU_MLIR_PRINCIPLES.md:** GPU execution patterns
- **SPEC-OPERATOR-REGISTRY.md:** Operator type system
- **SPEC-SCHEDULER.md:** Simulation phase scheduling
- **SPEC-TYPE-SYSTEM.md:** Unit system and type safety
- **DOMAIN_ARCHITECTURE.md:** Multi-domain vision
