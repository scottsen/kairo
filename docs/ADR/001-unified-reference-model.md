...
- **SPEC-COORDINATE-FRAMES.md** — Kairo frame/anchor specification
- **SPEC-TRANSFORM.md** — Frame-aware transformations
- **SPEC-GEOMETRY.md** — Geometry domain with auto-generated anchors
- **DOMAIN_ARCHITECTURE.md** — Cross-domain reference model
