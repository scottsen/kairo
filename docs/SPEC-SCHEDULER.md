...
- `SPEC-TYPE-SYSTEM.md` — Rate annotations on Stream types
- `SPEC-PROFILES.md` — Profile affects block size and resampling
- `SPEC-GRAPH-IR.md` — Graph IR includes rate annotations
- `SPEC-SNAPSHOT-ABI.md` — State snapshot format
