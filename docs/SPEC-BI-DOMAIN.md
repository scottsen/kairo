...
**Related:** ADR-005 (GPU-First Domains), SPEC-KAX-LANGUAGE.md
...
See **SPEC-KAX-LANGUAGE.md** for full details.
...
- **ADR-005:** GPU-First Domains Architecture Decision
- **SPEC-KAX-LANGUAGE:** KAX Expression Language Specification
- **SPEC-OPERATOR-REGISTRY:** Operator registration and extensibility
- **SPEC-SCHEDULER:** Kairo scheduling and execution model
- **GPU_MLIR_PRINCIPLES:** GPU lowering and MLIR integration
