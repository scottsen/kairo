...
- `EXECUTION_PLAN_Q4_2025.md` (Nov 15, 2025) - "Show → Validate → Build" approach
...
1. ⭐ **Start here:** Read [ROADMAP_2025_Q4.md](./ROADMAP_2025_Q4.md) - especially "Quick Reference: This Week's Priorities"
...
├── ROADMAP_2025_Q4.md                ← ⭐ CANONICAL ROADMAP
├── SHOWCASE_OUTPUT_STRATEGY.md       ← Active (tactical guidance)
└── archive/                          ← Historical documents
    ├── NEXT_STEPS_ACTION_PLAN.md
    ├── STRATEGIC_NEXT_STEPS.md
    ├── PROJECT_REVIEW_AND_NEXT_STEPS.md
    ├── EXECUTION_PLAN_Q4_2025.md
