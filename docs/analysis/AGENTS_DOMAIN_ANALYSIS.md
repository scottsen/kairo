...
### Core Files
- **Primary Implementation**: `/home/user/kairo/kairo/stdlib/agents.py` (544 lines)
- **MLIR Dialect**: `/home/user/kairo/kairo/mlir/dialects/agent.py` (526 lines)
- **MLIR Lowering**: `/home/user/kairo/kairo/mlir/lowering/agent_to_scf.py` (424 lines)
- **Examples**: `/home/user/kairo/examples/agents/boids.ccdsl`, `/home/user/kairo/examples/phase4_agent_operations.py`
- **Tests**: `/home/user/kairo/tests/test_agents_*.py` (5+ test files)

### Directory Structure
```
kairo/
├── kairo/stdlib/agents.py          # NumPy backend implementation
├── kairo/mlir/dialects/agent.py    # High-level agent operations
├── kairo/mlir/lowering/agent_to_scf.py  # Lowering to control flow
├── kairo/stdlib/visual.py          # Visualization (with agent rendering)
