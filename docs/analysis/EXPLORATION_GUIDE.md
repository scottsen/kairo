...
1. `/home/user/kairo/README.md` - Project overview
...
2. `/home/user/kairo/ARCHITECTURE.md` - System architecture
3. `/home/user/kairo/STATUS.md` - Implementation status
4. `/home/user/kairo/ECOSYSTEM_MAP.md` - Domain ecosystem

### For Implementation (reference as needed)
1. `NEXT_STEPS_ACTION_PLAN.md` - Strategy and checklist
2. `/home/user/kairo/kairo/stdlib/noise.py` - Template domain implementation
3. `/home/user/kairo/examples/showcase/01_fractal_explorer.py` - Template example
4. `/home/user/kairo/tests/test_optimization_operations.py` - Template tests

## Key Absolute Paths

### Core Files
- `/home/user/kairo/kairo/stdlib/` - All domain implementations
- `/home/user/kairo/examples/` - All examples (34+ files)
- `/home/user/kairo/tests/` - All tests (580+)
- `/home/user/kairo/docs/specifications/` - Domain specifications

### Documentation
- `/home/user/kairo/CODEBASE_EXPLORATION_SUMMARY.md` - You are here ✓
- `/home/user/kairo/ARCHITECTURE.md` - System design
- `/home/user/kairo/STATUS.md` - Current status
- `/home/user/kairo/ECOSYSTEM_MAP.md` - Domain ecosystem
- `/home/user/kairo/CHANGELOG.md` - Version history

### Top Specifications (Not Yet Implemented)
- `/home/user/kairo/docs/specifications/circuit.md` - Circuit simulation (PRIORITY 1)
- `/home/user/kairo/docs/specifications/geometry.md` - CAD/Geometry
- `/home/user/kairo/docs/specifications/chemistry.md` - Chemistry simulation
...
- **Architecture**: See `/home/user/kairo/ARCHITECTURE.md`
- **Domain Patterns**: See `/home/user/kairo/docs/adr/002-cross-domain-architectural-patterns.md`
- **Language Spec**: See `/home/user/kairo/SPECIFICATION.md` (47KB)
- **Implementation Examples**: See `/home/user/kairo/kairo/stdlib/noise.py` (good template)
- **Test Examples**: See `/home/user/kairo/tests/test_optimization_operations.py`
