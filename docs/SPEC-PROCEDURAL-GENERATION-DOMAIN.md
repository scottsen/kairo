...
The EmergenceDomain (ADR-004, SPEC-EMERGENCE-DOMAIN.md) includes basic L-systems for string rewriting and turtle graphics. The ProceduralDomain **extends** this foundation with:
