...
- `SPEC-SCHEDULER.md` — Scheduler state included in snapshots
- `SPEC-OPERATOR-REGISTRY.md` — Operator state schemas
- `SPEC-PROFILES.md` — Profile affects snapshot compatibility
- `SPEC-TYPE-SYSTEM.md` — Type serialization
