...
- `kairo/types/units.py`: Unit system implementation with dimensional analysis
- `kairo/ast/types.py`: Type system integration with unit compatibility
- `kairo/ast/visitors.py`: Type checker with unit validation

### API Reference

See inline documentation in:
- `/home/user/kairo/kairo/types/units.py:1` - Core unit system classes
- `/home/user/kairo/kairo/ast/types.py:7` - Type system integration
- `/home/user/kairo/kairo/ast/visitors.py:96` - Type checker enhancements

### Test Coverage

Comprehensive tests in:
- `/home/user/kairo/tests/test_units.py:1` - Unit system tests covering:
  - Dimensional analysis
  - Unit algebra
  - Parsing
