...
- `SPEC-TYPE-SYSTEM.md` — Determinism tiers affect type behavior
- `SPEC-OPERATOR-REGISTRY.md` — Operators declare determinism tiers
- `SPEC-SCHEDULER.md` — Scheduler uses profile block sizes
- `SPEC-TRANSFORM.md` — Transform ops use profile FFT settings
