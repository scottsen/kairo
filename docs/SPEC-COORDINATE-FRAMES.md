...
**Dependencies:** SPEC-TYPE-SYSTEM.md, SPEC-TRANSFORM.md, SPEC-OPERATOR-REGISTRY.md
...
- SPEC-TRANSFORM.md — Transform dialect (`reparam`, coordinate conversions)
- SPEC-TYPE-SYSTEM.md — Units and type system
- SPEC-OPERATOR-REGISTRY.md — Operator organization
