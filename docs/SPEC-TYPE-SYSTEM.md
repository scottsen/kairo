...
- `SPEC-GRAPH-IR.md` — Graph IR uses these types
- `SPEC-TRANSFORM.md` — Transform operations change domains
- `SPEC-SCHEDULER.md` — Scheduler uses rate annotations
- `SPEC-PROFILES.md` — Profiles affect type behavior (precision, determinism)
