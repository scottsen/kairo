...
| `Frame<3>` | 3D coordinate frame | Meta | See SPEC-COORDINATE-FRAMES.md |
...
See **SPEC-COORDINATE-FRAMES.md** for full details.
...
See **SPEC-TRANSFORM.md** and **SPEC-COORDINATE-FRAMES.md**.
...
See **SPEC-COORDINATE-FRAMES.md** for full specification.
...
See **SPEC-OPERATOR-REGISTRY.md** for full registry integration.
...
- **SPEC-COORDINATE-FRAMES.md** — Frame/anchor system specification
- **SPEC-TRANSFORM.md** — Spatial transformations
- **SPEC-OPERATOR-REGISTRY.md** — 7-layer operator architecture
- **DOMAIN_ARCHITECTURE.md** — Cross-domain vision
