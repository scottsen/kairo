...
```bash
kairo run --watch simulation.kairo  # Auto-reload on changes
```
...
**Where to discuss:**
- GitHub Discussions: https://github.com/scottsen/kairo/discussions
- GitHub Issues: https://github.com/scottsen/kairo/issues
