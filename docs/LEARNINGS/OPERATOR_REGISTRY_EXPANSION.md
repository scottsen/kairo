...
**Related:** ADR-002, DOMAIN_ARCHITECTURE.md, DOMAIN_IMPLEMENTATION_GUIDE.md
...
**Status:** Partially implemented in `kairo/stdlib/audio.py`
...
**Status:** Partially specified in `docs/SPEC-GEOMETRY.md` (RFC)
...
**See `SPEC-GEOMETRY.md` for complete operator catalog.**
...
**Primary:** `SpatialRef` (defined in `SPEC-COORDINATE-FRAMES.md`)
...
**See:** `docs/SPEC-GEOMETRY.md` for full specification.
