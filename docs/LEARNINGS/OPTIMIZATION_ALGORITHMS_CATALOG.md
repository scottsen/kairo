...
**Related:** DOMAIN_ARCHITECTURE.md, ADR-002
...
- `docs/SPEC-OPTIMIZATION.md` (domain specification)
...
### Kairo Architecture
- **DOMAIN_ARCHITECTURE.md** — Section 2.3 (Optimization domain overview)
- **ADR-002** — Cross-domain architectural patterns
- **SPEC-OPERATOR-REGISTRY.md** — Operator registration
- **SPEC-TYPE-SYSTEM.md** — GenomeSpec type definitions
- **GPU_MLIR_PRINCIPLES.md** — Parallel evaluation strategies
