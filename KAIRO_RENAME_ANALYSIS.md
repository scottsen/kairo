...
```
/home/user/kairo/README.md              (50+ references)
/home/user/kairo/ARCHITECTURE.md        (45+ references)
/home/user/kairo/SPECIFICATION.md       (180+ references - code blocks)
/home/user/kairo/CHANGELOG.md           (150+ references)
/home/user/kairo/AUDIO_SPECIFICATION.md (50+ references)
/home/user/kairo/STATUS.md              (30+ references)
/home/user/kairo/ECOSYSTEM_MAP.md       (20+ references)
/home/user/kairo/LEVEL_3_TYPE_SYSTEM.md (40+ references)
```
...
```
kairo/mlir/dialects/audio.py           (34 occurrences)
kairo/mlir/dialects/temporal.py        (39 occurrences)
kairo/mlir/dialects/field.py           (26 occurrences)
kairo/mlir/dialects/agent.py           (26 occurrences)
kairo/mlir/lowering/audio_to_scf.py    (26 occurrences)
kairo/mlir/lowering/temporal_to_scf.py (24 occurrences)
kairo/mlir/lowering/field_to_scf.py    (18 occurrences)
kairo/mlir/lowering/agent_to_scf.py    (18 occurrences)
```
...
```
/home/user/kairo/                    ← Project root (rename to /morphogen/)
├── .github/
│   └── workflows/
...
├── kairo/                           ← Main package dir (76 files, 576 refs) ← RENAME THIS
├── tests/                           ← Test suite (62 files, 353 refs)
├── kairo/__init__.py                ← Package init (5 refs)
├── kairo/cli.py                     ← CLI entry point (12 refs)
├── ARCHITECTURE.md
...
1. **Package Directory** (1 change)
   - Rename `/home/user/kairo/kairo/` → `/home/user/kairo/morphogen/`
...
```
/home/user/kairo/kairo/cli.py
  - Check if "kairo" appears in user-facing strings/help text
  
/home/user/kairo/kairo/__init__.py
  - Update docstring and version number
  
/home/user/kairo/kairo/core/domain_registry.py
...
MLIR Dialects & Lowering:
  kairo/mlir/dialects/audio.py         (34 refs)
  kairo/mlir/dialects/temporal.py      (39 refs)
  kairo/mlir/dialects/field.py         (26 refs)
  kairo/mlir/dialects/agent.py         (26 refs)
  kairo/mlir/lowering/audio_to_scf.py  (26 refs)
  kairo/mlir/lowering/temporal_to_scf.py (24 refs)
  kairo/mlir/lowering/field_to_scf.py  (18 refs)
  kairo/mlir/lowering/agent_to_scf.py  (18 refs)

Core Modules:
  kairo/core/domain_registry.py        (26 refs)
  kairo/cli.py                         (12 refs)
  kairo/__init__.py                    (5 refs)
```
...
```python
# kairo/__init__.py (new shim package)
import warnings
warnings.warn(
...
- [ ] Rename `kairo/` directory to `morphogen/`
