...
class TestArgumentParsing:
    ...
    def test_check_command_parsing(self):
        ...
        test_args = ['kairo', 'check', 'test.kairo', '--strict']
    ...
    def test_parse_command_parsing(self):
        ...
        for fmt in ['tree', 'json', 'graphviz']:
            test_args = ['kairo', 'parse', 'test.kairo', '--format', fmt]
    ...
    def test_mlir_command_parsing(self):
        ...
        for dialect in ['all', 'linalg', 'scf', 'arith']:
            test_args = ['kairo', 'mlir', 'test.kairo', '--dialect', dialect]
    ...
    def test_default_values(self):
        ...
        test_args = ['kairo', 'run', 'test.kairo']
...
class TestCmdVersion:
    ...
    def test_version_output(self, capsys):
        ...
        # Note: CLI imports from 'kairo' but it doesn't exist, so we patch both possibilities
        try:
            import kairo
        ...
        with patch(patch_target, '0.2.2'):
            try:
                ...
                pytest.skip("CLI references non-existent 'kairo' module")
...
class TestIntegrationWithRealFiles:
    ...
    def test_parse_real_example(self):
        ...
        example_file = Path('/home/user/kairo/examples/01_hello_heat.kairo')
