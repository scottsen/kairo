...
**Spec File**: `/home/user/kairo/docs/specifications/circuit.md` (1136 lines)
**ADR**: `/home/user/kairo/docs/adr/003-circuit-modeling-domain.md`

**Implementation Plan**:
- Create `/home/user/kairo/kairo/stdlib/circuit.py` (~600-800 lines)
...
- Integrators (RK4, Verlet) - `/home/user/kairo/kairo/stdlib/integrators.py`
- Visualization - `/home/user/kairo/kairo/stdlib/visual.py`
- Field operations - `/home/user/kairo/kairo/stdlib/field.py`

**Implementation Plan**:
- Create `/home/user/kairo/kairo/stdlib/rigid_body.py` (~500 lines)
...
**Building Blocks Available**:
- Field2D operations - `/home/user/kairo/kairo/stdlib/field.py`
- Visual rendering - `/home/user/kairo/kairo/stdlib/visual.py`
- Noise for random initialization - `/home/user/kairo/kairo/stdlib/noise.py`

**Implementation Plan**:
- Create `/home/user/kairo/kairo/stdlib/cellular.py` (~250-300 lines)
...
1. **Interactive Physics Sandbox**
   ...
   - Files to create:
     - `/home/user/kairo/examples/interactive_physics_sandbox/demo.py`
     - `/home/user/kairo/examples/interactive_physics_sandbox/README.md`
...
2. **Real-Time Audio Visualizer**
   ...
   - Files to create:
     - `/home/user/kairo/examples/audio_visualizer/real_time_demo.py`
...
3. **Generative Art Installation**
   ...
   - Files to create:
     - `/home/user/kairo/examples/generative_art/installation.py`
...
4. **Scientific Discovery Workflow**
   ...
   - Files to create:
     - `/home/user/kairo/examples/scientific_discovery/complete_workflow.py`
...
1. **Geometry/CAD** - 3000+ lines of spec at `/home/user/kairo/docs/specifications/geometry.md`
2. **Fluid Dynamics** - Spec at `/home/user/kairo/docs/specifications/physics-domains.md`
3. **Chemistry** - 2200+ lines at `/home/user/kairo/docs/specifications/chemistry.md`
...
### Template Files
- Domain template: `/home/user/kairo/kairo/stdlib/noise.py` (clean 3-layer structure)
- Example template: `/home/user/kairo/examples/showcase/01_fractal_explorer.py`
- Test template: `/home/user/kairo/tests/test_optimization_operations.py`

### Architecture References
- Domain patterns: See `/home/user/kairo/ARCHITECTURE.md`
- Cross-domain integration: `/home/user/kairo/docs/adr/002-cross-domain-architectural-patterns.md`
- Specification template: `/home/user/kairo/docs/specifications/operator-registry.md`
...
| Purpose | Location |
|---------|----------|
| Domain implementation template | `/home/user/kairo/kairo/stdlib/noise.py` |
| Example template | `/home/user/kairo/examples/showcase/01_fractal_explorer.py` |
| Test template | `/home/user/kairo/tests/test_optimization_operations.py` |
| Circuit specification | `/home/user/kairo/docs/specifications/circuit.md` |
| Architecture guide | `/home/user/kairo/ARCHITECTURE.md` |
| Domain pattern ADR | `/home/user/kairo/docs/adr/002-cross-domain-architectural-patterns.md` |
| Ecosystem overview | `/home/user/kairo/ECOSYSTEM_MAP.md` |
| Current status | `/home/user/kairo/STATUS.md` |
...
[ ] Added to kairo/stdlib/__init__.py
