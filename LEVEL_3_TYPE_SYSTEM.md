...
### 1. Rate System (`kairo/types/rate_compat.py`)
...
### 2. Stream Types in Type System (`kairo/ast/types.py`)
...
### 3. Enhanced Cross-Domain Validators (`kairo/cross_domain/validators.py`)
...
### Modified:
- `kairo/ast/types.py` - Added Rate enum, StreamType, sig/ctl/evt helpers
- `kairo/cross_domain/validators.py` - Added unit and rate validation functions

### Created:
- `kairo/types/rate_compat.py` - Complete rate compatibility system
