...
from kairo.core.operator import get_operator_metadata, OperatorMetadata
...
class DomainRegistry:
    ...
    def register(cls, name: str, module_path: str, description: str = "") -> DomainDescriptor:
        ...
        Args:
            ...
            module_path: Python module path (e.g., "kairo.stdlib.graph")
...
def register_stdlib_domains() -> None:
    ...
    """
    domains = [
        ("field", "kairo.stdlib.field", "Spatial field simulation and computation"),
        ("agent", "kairo.stdlib.agents", "Agent-based modeling and simulation"),
        ("audio", "kairo.stdlib.audio", "Audio synthesis and processing"),
        ("visual", "kairo.stdlib.visual", "Visual rendering and graphics"),
        ("rigidbody", "kairo.stdlib.rigidbody", "Rigid body physics simulation"),
        ("integrators", "kairo.stdlib.integrators", "Numerical integration methods"),
        ("graph", "kairo.stdlib.graph", "Graph and network algorithms"),
        ("signal", "kairo.stdlib.signal", "Signal processing and analysis"),
        ("statemachine", "kairo.stdlib.statemachine", "State machines and behavior trees"),
        ("terrain", "kairo.stdlib.terrain", "Procedural terrain generation"),
        ("vision", "kairo.stdlib.vision", "Computer vision and image processing"),
        ("cellular", "kairo.stdlib.cellular", "Cellular automata"),
        ("optimization", "kairo.stdlib.optimization", "Optimization algorithms"),
        ("neural", "kairo.stdlib.neural", "Neural network primitives"),
        ("sparse_linalg", "kairo.stdlib.sparse_linalg", "Sparse linear algebra"),
        ("io_storage", "kairo.stdlib.io_storage", "I/O and data storage"),
        ("acoustics", "kairo.stdlib.acoustics", "Room acoustics and propagation"),
        ("noise", "kairo.stdlib.noise", "Noise generation algorithms"),
        ("color", "kairo.stdlib.color", "Color space operations"),
        ("image", "kairo.stdlib.image", "Image manipulation"),
