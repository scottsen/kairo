...
- **Domain Documentation**:
  - `kairo/stdlib/noise.py`: Noise generation
  - `kairo/stdlib/palette.py`: Color palettes
  - `kairo/stdlib/field.py`: Field operations
  - `kairo/stdlib/integrators.py`: Time integration
  - `kairo/stdlib/sparse_linalg.py`: Sparse linear algebra
  - `kairo/stdlib/image.py`: Image processing
  - `kairo/stdlib/io_storage.py`: I/O operations
