...
def example_electrostatics():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_02_electrostatics.png', dpi=150)
...
def example_pressure_projection():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_02_pressure_projection.png', dpi=150)
...
def example_periodic_boundary():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_02_periodic.png', dpi=150)
