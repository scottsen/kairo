...
def example_solver_comparison_symmetric():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_03_symmetric_comparison.png', dpi=150)
...
def example_solver_comparison_nonsymmetric():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_03_nonsymmetric_comparison.png', dpi=150)
...
def example_large_scale_performance():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_03_large_scale_performance.png', dpi=150)
