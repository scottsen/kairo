...
def example_1d_heat_equation():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_01_heat_1d.png', dpi=150)
...
def example_2d_heat_equation():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_01_heat_2d.png', dpi=150)
...
def example_convergence_analysis():
    ...
    plt.tight_layout()
    plt.savefig('/home/user/kairo/examples/sparse_linalg/output_01_convergence.png', dpi=150)
