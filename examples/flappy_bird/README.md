...
| **File** | **Purpose** | **Lines** |
|----------|-------------|-----------|
| `kairo/stdlib/flappy.py` | Game physics domain (gravity, collision, pipes) | ~450 |
| `kairo/stdlib/neural.py` | Neural network domain (MLP, activations, inference) | ~400 |
| `kairo/stdlib/genetic.py` | Genetic algorithm domain (selection, crossover, mutation) | ~450 |
