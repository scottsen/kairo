...
def main():
    ...
    genome_path = '/home/user/kairo/examples/flappy_bird/best_genome.npy'
    ...
    if os.path.exists(genome_path):
        ...
        visualize_episode(
            genome=genome,
            max_steps=1000,
            save_path='/home/user/kairo/examples/flappy_bird/best_agent.png'
        )
    else:
        ...
        visualize_episode(
            genome=None,
            max_steps=200,
            save_path='/home/user/kairo/examples/flappy_bird/random_agent.png'
        )
